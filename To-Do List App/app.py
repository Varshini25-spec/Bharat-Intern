...
class TodoListApp(tk.Tk):
    def __init__(self):
        ...
        style.configure("Custon.TEntry", foreground="light gray")
        ...
        self.task_input.insert(0, "Enter your to-do list here...")
    ...
    def view_stats(self):
        ...
        for i in range(total_count):
            if self.task_list.itemcget(i, "fg") == "green":
                done_count += 1
        messagebox.showinfo("Task Status", f"Total tasks: {total_count}\nCompleted tasks: {done_count}")

    def add_task(self):
        task = self.task_input.get()
        if task != "Enter your to-do list here...":
    ...
    def clear_placeholder(self, event):
        if self.task_input.get() == "Enter your to-do list here...":
            self.task_input.delete(0, tk.END)
